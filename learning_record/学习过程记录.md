...
- 注意，这部分开始玩的时候最好从主菜单进入，否则会报奇怪的错误：`NullReferenceException: Object reference not set to an instance of an object DragItem.SwapItem () (at Assets/Scripts/Inventory/UI/DragItem.cs:89)`
